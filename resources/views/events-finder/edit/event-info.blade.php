            ...
            <form action="{{ route('event-manage.edit-event-info.action') }}" method="POST">
                ...
                <div class="row-container align-items-center px-3 mt-md-2 mt-sm-0 mt-xs-0 mt-0">
                    <div class="section-header row w-100 m-0 py-2 d-flex align-items-center">
                        <div class="col-left-alt col-lg-6 col-md-5 col-12 mt-xl-2 mt-md-2 mt-sm-2 mt-2 mb-sm-1 mb-xs-2">
                            <h3 class="rserif fw-bold w-100">Edit event info</h3>
                        </div>
                        <div id="col-action-buttons-standard" class="col-right-alt col-lg-6 col-md-7 col-12 align-self-center mb-xl-0 mb-md-0 mb-sm-3 mb-3">
