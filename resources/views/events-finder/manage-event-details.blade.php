...
<body class="d-flex flex-column min-vh-100" style="background-color: #F8F8F8;">
    ...
    <x-response-popup
        ...
        title="Success!"/>
    <!-- BREADCRUMB NAV -->
    <div id="event-breadcrumb" class="row w-80 justify-content-start mx-auto py-4 my-0">
    ...
    <div id="event-breadcrumb-alt" class="row w-100 mx-auto py-3">
            ...
            <div class="row-container d-flex align-items-center">
                <div class="align-items-center w-100 px-3">
                    ...
                    @if (!empty($eventImagePaths))
                        <div id="event-images-list" class="row py-4">
                            @foreach ($eventImagePaths as $index => $imagePath)
                                <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                                    <img src="{{ Storage::url($imagePath) }}" alt="Event illustration" class="img-fluid border" style="aspect-ratio: 4/4; object-fit: cover; cursor: pointer;"
