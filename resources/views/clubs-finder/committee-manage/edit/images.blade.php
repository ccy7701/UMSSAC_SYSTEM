        ...
        <div id="main-card" class="card">
            <div class="row-container align-items-center px-3 mt-md-2 mt-sm-0 mt-xs-0 mt-0">
                <div class="section-header row w-100 m-0 py-2 d-flex align-items-center">
                    <div class="col-left-alt col-lg-8 col-md-12 col-12 mt-xl-2 mt-md-2 mt-sm-2 mt-2 mb-sm-1 mb-xs-2">
                        <h3 class="rserif fw-bold w-100">Edit club images</h3>
                    </div>
                    <div id="col-right-img-edit" class="col-right-alt col-lg-4 col-md-7 col-12 align-self-center mb-xl-0 mb-md-0 mb-sm-3 mb-3">
                        <a href="{{ route('committee-manage.manage-details', ['club_id' => $club->club_id]) }}" class="w-xxl-50 w-lg-100 rsans btn btn-secondary fw-bold px-3">Go back</a>
                    </div>
                </div>
            </div>
            <!-- BODY OF CONTENT -->
                    ...
                    <div class="rsans modal fade" id="add-club-image-modal" tabindex="-1" aria-labelledby="addClubImageModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content">
                                ...
                                <form id="add-club-image-form" method="POST" action="{{ route('committee-manage.edit-images.add', ['club_id' => $club->club_id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
