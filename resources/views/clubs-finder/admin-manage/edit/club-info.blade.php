            ...
            <form action="{{ route('admin-manage.edit-club-info.action') }}" method="POST">
                ...
                <div class="row-container align-items-center px-3 mt-md-2 mt-sm-0 mt-xs-0 mt-0">
                    <div class="section-header row w-100 m-0 py-2 d-flex align-items-center">
                        <div class="col-left-alt col-lg-6 col-md-4 col-12 mt-xl-2 mt-md-2 mt-sm-2 mt-2 mb-sm-1 mb-xs-2">
                        ...
                        <div id="col-action-buttons-standard" class="col-right-alt col-lg-6 col-md-8 col-12 align-self-center mb-xl-0 mb-md-0 mb-sm-3 mb-3">
                            ...
                            <button type="submit" class="section-button-short rsans btn btn-primary fw-semibold px-3">Save</button>
                        </div>
                    </div>
                </div>
                @if ($errors->any())
