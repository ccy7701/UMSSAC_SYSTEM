...
<div class="card h-100 align-items-center justify-content-center" id="card-join-request">
    <div class="rsans w-100 px-2 card-body text-center d-flex flex-column align-items-center justify-content-center">
        ...
        <p class="fst-italic text-muted mb-0">({{ $user->profile->profile_nickname != '' ? $user->profile->profile_nickname : 'No nickname' }})</p>
        <span class="d-inline-flex align-items-center text-muted">
            <i class="fa fa-university me-2"></i>
            <p class="mb-0">{{ $user->profile->profile_faculty != '' ? $user->profile->profile_faculty : 'Unspecified' }}</p>
        </span>
